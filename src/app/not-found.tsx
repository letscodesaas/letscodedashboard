...
import { Home, Search, ArrowLeft, FileQuestion, Users, Settings, Briefcase, Calendar } from "lucide-react"
            ...
            <div className="mx-auto max-w-2xl text-center">
                ...
                <Card className="mx-auto max-w-md">
                    ...
                    <CardContent>
                        <p className="mb-4 text-sm text-muted-foreground">
                            Try using the search functionality or contact your system administrator for assistance.
                        </p>
                ...
                <div className="mt-8 text-center">
                    <p className="text-sm text-muted-foreground">
                        ...
                        <Link href="/dashboard/support" className="font-medium text-primary underline-offset-4 hover:underline">
                            support team
                        </Link>
                        .
                    </p>
