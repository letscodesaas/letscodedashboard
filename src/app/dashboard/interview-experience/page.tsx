        ...
        try {
            ...
            if (data.success) {
                setInterviewExperiences(prev =>
                    prev.map(exp => exp._id === id ? { ...exp, isFeatured: !exp.isFeatured } : exp)
                );
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto px-6 py-6">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Manage interview experiences and user submissions</p>
                        </div>
                        <div className="flex gap-3">
                            <button className="flex items-center gap-2 px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50"
                                onClick={() => {
                                    ...
                                    setSearchTerm('');
                                    clearMessages();
                                    toast.info('This feature is under development. Please check back later.', { duration: 5000 });
                                }}
                            >
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                {/* Alert Messages */}
                {(error || successMessage) && (
                    <div className={`mb-6 p-4 rounded-lg border ${error ? 'bg-red-50 border-red-200 text-red-700' : 'bg-green-50 border-green-200 text-green-700'}`}>
                    ...
                    <div className="bg-white p-6 rounded-xl border border-gray-200">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{interviewExperiences.length}</p>
                            </div>
                        </div>
                    </div>
                    <div className="bg-white p-6 rounded-xl border border-gray-200">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{pendingExperiences.length}</p>
                            </div>
                        </div>
                    </div>
                    <div className="bg-white p-6 rounded-xl border border-gray-200">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{interviewExperiences.filter(exp => exp.isApproved).length}</p>
                            </div>
                        </div>
                    </div>
                    <div className="bg-white p-6 rounded-xl border border-gray-200">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{interviewExperiences.filter(exp => exp.isFeatured).length}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="p-6">
                            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
                                ...
                                <div className="flex space-x-1 bg-gray-100 rounded-lg p-1">
                                    {[
                                        { key: 'pending', label: 'Pending', count: pendingExperiences.length },
                                        { key: 'all', label: 'All', count: interviewExperiences.length },
                                        { key: 'approved', label: 'Approved', count: interviewExperiences.filter(exp => exp.isApproved).length },
                                        { key: 'rejected', label: 'Rejected', count: interviewExperiences.filter(exp => exp.isApproved === false && exp.feedback).length }
                                    ].map((tab) => (
                                        <button
                                            key={tab.key}
                                ...
                                {loading ? (
                                    ...
                                    getFilteredExperiences().map((exp) => (
                                        <tr key={exp._id} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4">
                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${getStatusColor(getStatus(exp))}`}>
                                                    {getStatus(exp).toUpperCase()}
                                                </span>
                                            </td>
                                            <td className="px-6 py-4">
                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${getDifficultyColor(exp.difficultyLevel)}`}>
                                                    {exp.difficultyLevel}
                                                </span>
                                            </td>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                        <div className="p-6 border-b border-gray-200">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">Detailed interview experience</p>
                                </div>
                                <button
                        ...
                        <div className="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2 text-sm">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">{selectedExperience.role}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Job Type:</span>
                                            <span className="font-medium">{selectedExperience.jobType}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Location:</span>
                                            <span className="font-medium">{selectedExperience.location || 'Not specified'}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Difficulty:</span>
                                            <span className={`px-2 py-1 rounded-full text-xs font-medium border ${getDifficultyColor(selectedExperience.difficultyLevel)}`}>
                                                {selectedExperience.difficultyLevel}
                                            </span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Offer Status:</span>
                                            <span className="font-medium">{selectedExperience.offerStatus}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2 text-sm">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">{selectedExperience.email}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Status:</span>
                                            <span className={`px-2 py-1 rounded-full text-xs font-medium border ${getStatusColor(getStatus(selectedExperience))}`}>
                                                {getStatus(selectedExperience)}
                                            </span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Featured:</span>
                                            <span className="font-medium">{selectedExperience.isFeatured ? 'Yes' : 'No'}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Submitted:</span>
                                            <span className="font-medium">{formatDate(selectedExperience.createdAt)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Rounds:</span>
                                            <span className="font-medium">{selectedExperience.rounds?.length || 0}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Experience Content */}
                            <div>
                                <h4 className="font-semibold text-gray-900 mb-3">Detailed Experience</h4>
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <p className="text-gray-700 whitespace-pre-wrap">{selectedExperience.detailedExperience}</p>
                                </div>
                            </div>

                            {/* Rejection Feedback */}
                            {getStatus(selectedExperience) === 'rejected' && selectedExperience.feedback && (
                                <div>
                                    <h4 className="font-semibold text-gray-900 mb-3">Rejection Feedback</h4>
                            ...
                            <div className="flex gap-2">
                                <Button onClick={() => {
                                    ...
                                    disabled={loading || selectedExperience.isApproved} color="green" className="flex-1"
                                >
                                    Approve
                                </Button>
                                <Button onClick={() => {
                                    ...
                                    className="flex-1"
                                    disabled={loading || getStatus(selectedExperience) !== 'rejected'}
                                >
                                    Reject
                                </Button>
                                <Button onClick={() => {
                    ...
                    <div className="bg-white rounded-xl max-w-md w-full">
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    onClick={() => selectedExperienceId && rejectExperience(selectedExperienceId)}
                    ...
                    <div className="bg-white rounded-xl max-w-md w-full">
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    onClick={() => selectedExperienceId && deleteExperience(selectedExperienceId)}
                                    disabled={loading}
                                    className="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
