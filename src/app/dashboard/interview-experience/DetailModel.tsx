                    ...
                    <div className="flex justify-between items-start">
                        <div className="flex-1">
                            ...
                            <p className="text-gray-600">
                                Submitted by {selectedExperience.isAnonymous ? "Anonymous User" : selectedExperience.name} •{" "}
                ...
                <div className="p-6 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            ...
                            <p className="text-blue-800 font-semibold">{selectedExperience.jobType}</p>
                        </div>

                        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                            <div className="flex items-center gap-2 mb-1">
                                <span
                                    className={`w-3 h-3 rounded-full ${selectedExperience.difficultyLevel === "Easy"
                                        ? "bg-green-500"
                                ...
                                />
                                <span className="text-sm font-medium text-green-900">Difficulty</span>
                            </div>
                            <p className="text-green-800 font-semibold">{selectedExperience.difficultyLevel}</p>
                        </div>

                        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                            <div className="flex items-center gap-2 mb-1">
                                <span className="text-sm font-medium text-purple-900">Offer Status</span>
                            </div>
                            <p
                                className={`font-semibold ${selectedExperience.offerStatus === "Selected"
                                    ? "text-green-700"
                        ...
                        <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                            <div className="flex items-center gap-2 mb-1">
                                <span className="text-sm font-medium text-orange-900">Rounds</span>
                            </div>
                            <p className="text-orange-800 font-semibold">{selectedExperience.rounds?.length || 0}</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-6">
                                ...
                                <div className="space-y-3 text-sm">
                                    ...
                                    {selectedExperience.interviewDate && (
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">{formatDate(selectedExperience.interviewDate)}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                                ...
                                <div className="space-y-3 text-sm">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-medium">
                                            {selectedExperience.isAnonymous ? "Anonymous" : selectedExperience.name}
                                        </span>
                                    </div>
                                    {!selectedExperience.isAnonymous && selectedExperience.email && (
                                        <div className="flex justify-between">
                                    ...
                                    {selectedExperience.graduationYear && (
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">{selectedExperience.graduationYear}</span>
                                        </div>
                                    )}
                                    {selectedExperience.collegeName && (
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">College:</span>
                                            <span className="font-medium">{selectedExperience.collegeName}</span>
                                        </div>
                                    )}
                                    {selectedExperience.currentStatus && (
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Current Status:</span>
                                            <span className="font-medium">{selectedExperience.currentStatus}</span>
                                        </div>
                                    )}
                                    {selectedExperience.currentRole && (
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Current Role:</span>
                                            <span className="font-medium">{selectedExperience.currentRole}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            {(selectedExperience.packageCTC || selectedExperience.duration) && (
                                <div className="bg-gray-50 rounded-lg p-5">
                                    <h4 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
                                    ...
                                    <div className="space-y-3 text-sm">
                                        {selectedExperience.packageCTC && (
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-medium text-green-700">{selectedExperience.packageCTC}</span>
                                            </div>
                                        )}
                        ...
                        <div className="space-y-6">
                            ...
                            {/* Resources Used */}
                            {selectedExperience.resourcesUsed && selectedExperience.resourcesUsed.length > 0 && (
                                <div className="bg-gray-50 rounded-lg p-5">
                                    <h4 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {selectedExperience.resourcesUsed.map((resource, index) => (
                                            <span
                                                key={index}
                            ...
                            <div className="bg-gray-50 rounded-lg p-5">
                                ...
                                <div className="space-y-3">
                                    ...
                                    {!selectedExperience.isAnonymous && selectedExperience.linkedIn && (
                                        <a
                                    ...
                                    {!selectedExperience.isAnonymous && selectedExperience.github && (
                                        <a
                                    ...
                                    {!selectedExperience.resumeLink && !selectedExperience.linkedIn && !selectedExperience.github && (
                            ...
                            <div className="bg-gray-50 rounded-lg p-5">
                                ...
                                <div className="space-y-3 text-sm">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-medium">{selectedExperience.isAnonymous ? "Yes" : "No"}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {selectedExperience.rounds && selectedExperience.rounds.length > 0 && (
                        <div>
                            <h4 className="font-semibold text-gray-900 mb-4 text-lg">Interview Rounds</h4>
                    ...
                    {/* Detailed Experience */}
                    <div>
                        <h4 className="font-semibold text-gray-900 mb-3 text-lg">Detailed Experience</h4>
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-5">
                            <p className="text-gray-700 whitespace-pre-wrap leading-relaxed">
                                <ReactMarkdown>
                                    {selectedExperience.detailedExperience || "No detailed experience provided."}
                                </ReactMarkdown>
                            </p>
                        </div>
                    </div>
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl max-w-md w-full">
                ...
                <div className="p-6">
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-700 mb-2">Rejection Feedback *</label>
                        <textarea
                            value={feedback}
